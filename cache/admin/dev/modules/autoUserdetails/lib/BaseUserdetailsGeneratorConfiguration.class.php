...
/**
 * userdetails module configuration.
 *
 ...
 */
class BaseUserdetailsGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%name%% - %%email_address%% - %%phone_number%% - %%comments%% - %%created_at%%';
  }
  ...
  {
    return array(  0 => 'name',  1 => 'email_address',  2 => 'phone_number',  3 => 'comments',  4 => 'created_at',);
  }
  ...
  {
      return array(  0 => 'id',  1 => 'name',  2 => 'email_address',  3 => 'phone_number',  4 => 'comments',  5 => 'created_at',  6 => 'updated_at',);
  }
